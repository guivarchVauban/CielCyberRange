...
| **Debian + FreePBX** | Téléphonie IP (Asterisk/FreePBX) | 2 vCPU | **3 Go** | 20 Go | Interface sur VLAN 40 (VoIP)  et sur VLAN30 (Administration) |
| **Debian Docker Host** | GLPI + Wazuh + Portainer | 4 vCPU | **8 Go** | 100 Go | Interface sur VLAN 30 (Administration) et VLAN 20 (Clients) |
